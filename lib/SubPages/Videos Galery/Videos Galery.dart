...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: VideosGalery('Videos Galery'),
    );
  }
}
...
class VideosGalery extends StatefulWidget {
  final List<VideoModel> _videos = [];
  late String title;

  VideosGalery(String sTitle) {
    title = sTitle;
  }
  ...
  @override
  _VideosGaleryState createState() => _VideosGaleryState();
}

class _VideosGaleryState extends State<VideosGalery> {
